...
public class C03Equals extends Object {
	public static void main(String[] args) {
		...
		System.out.println(b1.equals(b2)); // false (참조값이 다름)
		System.out.println(b2.equals(b1)); // false (참조값이 다름)
		System.out.println(b1.equals(b1)); // true  (참조값이 같음)
		System.out.println(b2.equals(b2)); // true  (참조값이 같음)
...
class Book extends Object{
	...
	public boolean equals(Object obj) {
		if(obj instanceof Book) {
			...
			if(obj != null) {   // nullPointerException 방지
