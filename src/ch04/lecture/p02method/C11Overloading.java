...
public class C11Overloading {
	public static void main(String[] args) {
		...
		method2(3.14);
		method2(5); 
		method2(3.14, 3); // 메소드가 같아도 파라미터의 타입, 개수, 순서가 다를 수 있음
		method2(3, 3.14); // 메소드가 같아도 파라미터의 타입, 개수, 순서가 다를 수 있음
	}
	...
	public static void method2(double a) {
		System.out.println("더블 타입 받는 메소드 2");
	}
	
	public static void method2() {
		// 메소드 overloading
		// 메소드명이 같아도 파라미터의 타입, 개수, 순서가 다를 수 있음
		System.out.println("파라미터없는 메소드 2");
	}
	
	public static void method2(int a) {
		System.out.println("파라미터있는 메소드 2");
	} 
